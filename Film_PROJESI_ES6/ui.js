...
static inputTemizle (element1,element2,element3){
element1.value="";
element2.value="";
element3.value="";
}

static displayMessage  (message,type){//mesaj godterme fonksiyomu bunu prototype kaydediyoruz ilkel yontemle
...
static loadAllFilms  (films){//tum filmeleri sayfa acilinca yuklemek icin kullnadik
...
static deleteFilmFromUI (element){//gelen a elementni element diye aliyoruz ve parentelementlerine ulasip onlari siliyoruz
